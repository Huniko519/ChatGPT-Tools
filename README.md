...
- [HappyCommit: HappyCommit is a delightful tool that harnesses the power of OpenAI's GPT-3.5 Turbo language model to generate meaningful and descriptive Git commit messages for you](https://github.com/jackbackes/happycommit)
...
### VsCode Extension
- [ChatGPT extension source in VS Code](https://github.com/gencay/vscode-chatgpt)
- [ChatGPT - Genie AI](https://marketplace.visualstudio.com/items?itemName=genieai.chatgpt-vscode)
- [Forked by @Christopher-Hayes: ChatGPT Reborn](https://marketplace.visualstudio.com/items?itemName=chris-hayes.chatgpt-reborn)
